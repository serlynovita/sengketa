...
Route::get('/pemohon', 'App\Http\Controllers\PemohonController@index');

Route::get('/pemohon/tambah', 'App\Http\Controllers\PemohonController@tambah');
 	
Route::post('/pemohon/store', 'App\Http\Controllers\PemohonController@store');

Route::get('/pemohon/edit/{id}', 'App\Http\Controllers\PemohonController@edit');
